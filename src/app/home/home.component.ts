...
import { SendhttpService } from '../shared/data-access/sendhttp.service';
...
export default class HomeComponent {
  ...
  sendHttpService = inject(SendhttpService);
  private router = inject(Router);

  sendMessage()
  { 
    console.log('send a rest api message');
    this.sendHttpService.sendRequest();
  }
